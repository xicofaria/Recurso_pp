...
public class ProjectMenu {
    ...
    public void showMenu() throws TaskAlreadyInProject, IllegalNumberOfTasks, ParticipantAlreadyInProject, IllegalNumberOfParticipantType {
        ...
        while (!exit) {
            Edition activeEdition = cblManager.getActiveEdition();  // declare activeEdition
            ...
            String optionStr = scanner.nextLine();  // ler uma linha completa de entrada
            try {
                int option = Integer.parseInt(optionStr);  // tentar converter a linha para um número inteiro
                switch (option) {
                    case 1:
                        // Adicionar projeto
                        ...
                        String projectNameToAdd = scanner.nextLine();
                    ...
                    case 8:
                        ...
                        if (activeEdition != null) {
                            Project projectToGetProgress = activeEdition.getProject(projectForProgress);
                    ...
                    case 9:
                        ...
                        if (activeEdition != null) {
                            Project projectToGet = activeEdition.getProject(projectNameToGet);
